...
import static br.com.lojacomum.web.rest.TestUtil.createFormattingConversionService;
...
public class ProdutoResourceIntTest {
    ...
    public void createProduto() throws Exception {
        ...
        assertThat(testProduto.getDataVencimento()).isEqualTo(DEFAULT_DATA_VENCIMENTO);
    }
    ...
    public void updateProduto() throws Exception {
        ...
        assertThat(testProduto.getDataVencimento()).isEqualTo(UPDATED_DATA_VENCIMENTO);
    }
